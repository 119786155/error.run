...
export function Comment(props: {
  ...
  return (
    <div onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)} role="button" tabIndex={0}>
...
const useCommentEditor = (options: Omit<CreatePlateEditorOptions, 'plugins'> = {}, deps = []) => {
