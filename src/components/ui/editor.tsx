  ...
  ),
  {
    ...
    variants: {
      ...
      variant: {
        ...
        default: 'size-full px-10 pt-4 pb-7 text-base sm:px-[max(64px,calc(50%-450px))]',
        demo: 'size-full px-10 pt-4 pb-7 text-base sm:px-[max(64px,calc(50%-450px))]',
        fullWidth: 'size-full px-10 pt-4 pb-7 text-base sm:px-24',
        none: '',
