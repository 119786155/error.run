...
export function BulletedListToolbarButton() {
  ...
  return (
    <ToolbarSplitButton pressed={open} tooltip={getContent('editor.list.unordered')}>
...
export function NumberedListToolbarButton() {
  ...
  return (
    <ToolbarSplitButton pressed={open} tooltip={getContent('editor.list.ordered')}>
      <ToolbarSplitButtonPrimary
        className="data-[state=on]:bg-accent data-[state=on]:text-accent-foreground"
        onClick={() =>
          toggleList(editor, {
...
export function TodoListToolbarButton(props: React.ComponentProps<typeof ToolbarButton>) {
  ...
  return (
    <ToolbarButton {...props} {...buttonProps} tooltip={getContent('editor.list.todo')}>
      <ListTodoIcon />
    </ToolbarButton>
  )
}
