export const notFound = {
  title: {
    ...
    tr: 'Eyvah! Bu sayfa kayboldu',
    nl: 'Oeps! Deze pagina is verdwaald',
    pl: 'Ups! Ta strona się zgubiła',
    th: 'อุпส! หน้านี้หลงทางไป',
    uk: 'Ой! Ця сторінка заблудилась',
  },
  message: {
    zh: '您访问的页面不存在或已被移动。',
    ...
    nl: 'De pagina die u zoekt bestaat niet of is verplaatst.',
    pl: 'Strona, której szukasz, nie istnieje lub została przeniesiona.',
    th: 'หน้าที่คุณกำลังค้นหาไม่มีอยู่หรือถูกย้ายไปแล้ว',
